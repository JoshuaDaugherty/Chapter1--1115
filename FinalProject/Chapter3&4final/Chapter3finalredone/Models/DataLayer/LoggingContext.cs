...

    {
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
		{
			...
			modelBuilder.Entity<ApplicationUser>().HasData(
			   new ApplicationUser() { Id = "1", UserName = "Joshua555", Email = "killerclutch@gmail.com", Reason = "Lose weight." },
			   new ApplicationUser() { Id = "2", UserName = "Random616", Email = "Random616@gmail.com", Reason = "Gain weight." },
			   new ApplicationUser() { Id = "3", UserName = "CoolBeans83", Email = "CoolBeans83@gmail.com", Reason = "I want to jump higher." },
			   new ApplicationUser() { Id = "4", UserName = "Fitnessguy454", Email = "Fitnessguy454@gmail.com", Reason = "I want to fill out shirts." }
			   );
